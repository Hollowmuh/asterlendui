...
//   // Function to force contract initialization
...
//   // Update signer when wallet connection changes
//   useEffect(() => {
...
//             await contract.lenderListings(listingId) : 
//             await contract.borrowerListings(listingId);
...
//               minInterestRate: listing.minInterestRate / 100,
//               maxDuration: listing.maxDuration / 86400,
//               acceptedCollateralTokens: listing.acceptedCollateralTokens,
//               minCollateralRatio: listing.minCollateralRatio / 100,
//               isActive: listing.isActive,
//               lendingToken: listing.lendingToken
//             });
//             consecutiveErrors = 0;
//           }
...
// // Enhanced createLenderListing function with proper parameter handling
...
//     const interestRateBips = Math.floor(parseFloat(minInterestRate));
    
//     // Convert duration to seconds
//     // Ensure it's an integer value
//     const durationSeconds = Math.floor(parseFloat(maxDuration)) *86400;
    
//     // Convert collateral ratio to basis points (multiply by 100)
//     // Ensure it's an integer value
//     const collateralRatioBips = Math.floor(parseFloat(minCollateralRatio));
...
//     // Create transaction with exact parameter types matching the smart contract
//     const tx = await contractInstance.createLenderListing(
//       amount,                    // uint256
//       BigInt(interestRateBips),     // uint256
//       BigInt(durationSeconds),      // uint256
//       acceptedCollateralTokens,     // address[]
//       BigInt(collateralRatioBips),  // uint256
...
//     isConnected,
//     userAddress,
//     forceInitializeContract  // Exposing this in case you need to initialize the contract elsewhere
//   };
// }
